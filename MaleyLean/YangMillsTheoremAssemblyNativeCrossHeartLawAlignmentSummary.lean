...
/--
Top-level export for the theorem/native cross-heart law alignment summary.
-/
theorem YangMillsTheoremAssemblyNativeCrossHeartLawAlignmentSummaryExportStatement :
