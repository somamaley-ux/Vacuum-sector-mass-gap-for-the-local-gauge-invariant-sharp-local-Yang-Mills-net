...
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationLawTriangleNamedLawsSummaryExportStatement
  ...
  S.theorem_parts.partD_vacuum_gap /\
  S.theorem_parts.endpoint_exact_object :=
  YangMillsAssemblyTopNativeCrossHeartFactorizationLawTriangleNamedLawsSummaryStatement
    S RC RD RE
