...
/--
Surface-level summary exposing the structured vacuum-gap-to-endpoint law
package.
-/
theorem YangMillsGapTransportEndpointLawPackageSummaryStatement :
  ...
  exact
    YangMillsGapTransportEndpointLawPackageWitnessStatement
      RC RD RE
