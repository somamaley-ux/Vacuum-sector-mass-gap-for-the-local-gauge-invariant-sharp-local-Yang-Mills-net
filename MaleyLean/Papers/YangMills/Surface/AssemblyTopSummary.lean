...
/--
Final theorem-facing Yang-Mills summary layer pointing directly to the compact
theorem-assembly witness object.
-/
theorem YangMillsAssemblyTopSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyWitnessSummaryStatement
      S RC RD RE
