...
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationLawTrianglePackageSummaryStatement
  ...
  S.theorem_parts.partD_vacuum_gap /\
  S.theorem_parts.endpoint_exact_object :=
  YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTrianglePackageAlignmentExportStatement
    S RC RD RE
