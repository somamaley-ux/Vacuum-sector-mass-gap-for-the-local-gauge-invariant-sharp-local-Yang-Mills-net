...
/--
Final theorem-facing Yang-Mills summary layer pointing directly to the joint
theorem/native/native-cross-heart-law alignment object.
-/
theorem YangMillsAssemblyTopNativeCrossHeartLawSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeCrossHeartLawAlignmentSummaryStatement
      S RC RD RE
