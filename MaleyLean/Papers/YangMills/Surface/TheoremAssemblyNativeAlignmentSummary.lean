...
/--
Surface-level summary tying the theorem-top witness surface to the native-law
consequence layer.
-/
theorem YangMillsTheoremAssemblyNativeAlignmentSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeAlignmentExportStatement
      S RC RD RE
