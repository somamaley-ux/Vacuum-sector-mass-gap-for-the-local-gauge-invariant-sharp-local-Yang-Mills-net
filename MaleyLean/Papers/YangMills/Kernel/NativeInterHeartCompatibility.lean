...
def YMNativeConstructiveStateToEndpointExactness
  (_RD : YMVacuumGapRoute)
  (RE : YMEndpointCore) : Prop :=
  YMSharpLocalState -> RE.endpoint_object.exact_local_net_endpoint
...
def YangMillsNativeVacuumGapToEndpointCompatibilityData
  ...
  intro _
  exact
    A.endpoint.exact_endpoint_from_correlations
      A.endpoint.interface.bundle.vacuum_correlations_defined
...
def YangMillsNativeConstructiveToEndpointCompatibilityData
  ...
  let hGap := YangMillsNativeConstructiveToVacuumGapCompatibilityData RC RD RE A
  let hEnd := YangMillsNativeVacuumGapToEndpointCompatibilityData RC RD RE A
  intro hbase
  exact hEnd (hGap hbase)
...
def YangMillsNativeConstructiveStateToEndpointExactnessData
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (C : YMNativeInterHeartCompatibility RC RD RE) :
  YMNativeConstructiveStateToEndpointExactness RD RE :=
  fun s => C.vacuum_gap_to_endpoint (C.constructive_state_to_vacuum_gap s).down

def YangMillsNativeConstructiveStateToVacuumGapReadinessFromAssemblyData
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (A : YMNativeLawAssembly RC RD RE) :
  ...
  fun s => ⟨
    (YangMillsNativeConstructiveToVacuumGapCompatibilityData RC RD RE A)
      (A.constructive.bounded_base_from_assembly s)⟩
  ...
  refine
    { constructive_to_vacuum_gap :=
      ...
      constructive_state_to_vacuum_gap :=
        YangMillsNativeConstructiveStateToVacuumGapReadinessFromAssemblyData RC RD RE A
...
theorem YangMillsNativeConstructiveVacuumGapRouteAgreementStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  C.constructive_to_vacuum_gap A.constructive.bounded_base_witness =
    (C.constructive_state_to_vacuum_gap A.constructive.interface.chosen_sharp_local_state).down := by
  rfl

theorem YangMillsNativeConstructiveStateToVacuumGapChosenAgreementStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  C.constructive_state_to_vacuum_gap A.constructive.interface.chosen_sharp_local_state =
    PLift.up (C.constructive_to_vacuum_gap A.constructive.bounded_base_witness) := by
  let A :=
    YangMillsNativeLawAssemblyData
      RC RD RE
      htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
  ...
  calc
    C.constructive_state_to_vacuum_gap A.constructive.interface.chosen_sharp_local_state =
      PLift.up
        (C.constructive_to_vacuum_gap
          (A.constructive.bounded_base_from_assembly
            A.constructive.interface.chosen_sharp_local_state)) := by
          rfl
    _ = PLift.up (C.constructive_to_vacuum_gap A.constructive.bounded_base_witness) := by
          exact
            congrArg (fun x => PLift.up (C.constructive_to_vacuum_gap x))
...
theorem YangMillsNativeConstructiveStateToVacuumGapFactorsThroughAssemblyStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  let C :=
    YangMillsNativeInterHeartCompatibilityData
      ...
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  C.constructive_state_to_vacuum_gap s =
    ⟨C.constructive_to_vacuum_gap (A.constructive.bounded_base_from_assembly s)⟩ := by
  rfl

theorem YangMillsNativeConstructiveStateToVacuumGapConstantOnStatesStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  let C :=
    YangMillsNativeInterHeartCompatibilityData
      ...
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  C.constructive_state_to_vacuum_gap s1 =
    C.constructive_state_to_vacuum_gap s2 := by
  let A :=
    YangMillsNativeLawAssemblyData
      RC RD RE
      htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
  ...
  calc
    C.constructive_state_to_vacuum_gap s1 =
      PLift.up (C.constructive_to_vacuum_gap (A.constructive.bounded_base_from_assembly s1)) := by
        exact
          YangMillsNativeConstructiveStateToVacuumGapFactorsThroughAssemblyStatement
            ...
            hE hP evac etest efield
            s1
    _ = PLift.up (C.constructive_to_vacuum_gap (A.constructive.bounded_base_from_assembly s2)) := by
        exact
          congrArg (fun x => PLift.up (C.constructive_to_vacuum_gap x))
            (YangMillsConstructiveBoundedBaseConstantOnStatesStatement
              RC htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
              s1 s2)
    _ = C.constructive_state_to_vacuum_gap s2 := by
        exact
          (YangMillsNativeConstructiveStateToVacuumGapFactorsThroughAssemblyStatement
            RC RD RE
            htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
...
theorem YangMillsNativeConstructiveEndpointRouteAgreementStatement
  ...
  let C :=
    YangMillsNativeInterHeartCompatibilityData
      ...
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  C.constructive_to_endpoint A.constructive.bounded_base_witness =
    C.vacuum_gap_to_endpoint
      (C.constructive_state_to_vacuum_gap A.constructive.interface.chosen_sharp_local_state).down := by
  rfl

theorem YangMillsNativeConstructiveEndpointFactorsThroughVacuumGapStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  (etest : (YangMillsEndpointSemanticBundleData RE hE hP).test_function_space)
  (efield : (YangMillsEndpointSemanticBundleData RE hE hP).field_family)
  (hbase : RC.sharp_local_package.sharp_local_state.extends_bounded_base) :
  let C :=
    YangMillsNativeInterHeartCompatibilityData
      RC RD RE
      htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  C.constructive_to_endpoint hbase =
    C.vacuum_gap_to_endpoint (C.constructive_to_vacuum_gap hbase) := by
  rfl

theorem YangMillsNativeConstructiveStateToEndpointChosenAgreementStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  let C :=
    YangMillsNativeInterHeartCompatibilityData
      ...
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  let f := YangMillsNativeConstructiveStateToEndpointExactnessData RC RD RE C
  f A.constructive.interface.chosen_sharp_local_state =
    C.constructive_to_endpoint A.constructive.bounded_base_witness := by
  exact
    (YangMillsNativeConstructiveEndpointRouteAgreementStatement
      RC RD RE
      htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield).symm

theorem YangMillsNativeConstructiveStateToEndpointFactorsThroughVacuumGapStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  let C :=
    YangMillsNativeInterHeartCompatibilityData
      ...
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  YangMillsNativeConstructiveStateToEndpointExactnessData RC RD RE C s =
    C.vacuum_gap_to_endpoint (C.constructive_state_to_vacuum_gap s).down := by
  rfl

theorem YangMillsNativeVacuumGapEndpointRouteAgreementStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  let C :=
    YangMillsNativeInterHeartCompatibilityData
      ...
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  C.vacuum_gap_to_endpoint A.vacuum_gap.minkowski_gap_witness =
