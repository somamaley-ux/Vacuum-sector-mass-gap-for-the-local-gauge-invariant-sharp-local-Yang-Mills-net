...
/--
Alignment layer tying the theorem/native/native-inter-heart surface to the
typed native cross-heart law consequence layer.
-/
structure YMTheoremAssemblyNativeCrossHeartLawAlignment
    (S : YMLoadBearingSpine)
    (RC : YMConstructiveRoute)
    (RD : YMVacuumGapRoute)
    (RE : YMEndpointCore) where
  theorem_native_inter_heart_alignment :
    YMTheoremAssemblyNativeInterHeartAlignment S RC RD RE
  native_cross_heart_law_consequences :
    YMNativeCrossHeartLawConsequences RC RD RE

def YangMillsTheoremAssemblyNativeCrossHeartLawAlignmentData
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMTheoremAssemblyNativeCrossHeartLawAlignment S RC RD RE := by
  refine
    { theorem_native_inter_heart_alignment :=
        YangMillsTheoremAssemblyNativeInterHeartAlignmentData
          S RC RD RE
...
theorem YangMillsTheoremAssemblyNativeCrossHeartLawAlignmentExportStatement
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  let A := YangMillsTheoremAssemblyNativeCrossHeartLawAlignmentData
    S RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield
  ...
  exact
    And.intro ⟨A⟩ <|
      And.intro ⟨A.theorem_native_inter_heart_alignment⟩ <|
        And.intro ⟨A.theorem_native_inter_heart_alignment.theorem_native_alignment⟩ <|
          And.intro ⟨A.native_cross_heart_law_consequences⟩ <|
            And.intro ⟨A.native_cross_heart_law_consequences.law_object⟩ <|
              And.intro ⟨A.native_cross_heart_law_consequences.native_consequences⟩ <|
                And.intro
                  ⟨A.native_cross_heart_law_consequences.law_object.compatibility⟩ <|
                  And.intro
                    A.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.partC_witness <|
                    And.intro
                      A.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.partD_witness
                      A.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.endpoint_part_witness
