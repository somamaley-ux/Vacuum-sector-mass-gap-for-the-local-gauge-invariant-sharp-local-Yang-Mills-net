...
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationLawTrianglePackageSummaryExportStatement
  ...
  S.theorem_parts.partD_vacuum_gap /\
  S.theorem_parts.endpoint_exact_object :=
  YangMillsAssemblyTopNativeCrossHeartFactorizationLawTrianglePackageSummaryStatement
    S RC RD RE
