...
/--
Top-level export for the theorem/native/native-cross-heart-law top summary.
-/
theorem YangMillsAssemblyTopNativeCrossHeartLawSummaryExportStatement :
  ...
  exact
    YangMillsAssemblyTopNativeCrossHeartLawSummaryStatement
      S RC RD RE
