...
\input{sections/04_rigidity}
\input{sections/05_auxiliary_data}
\input{sections/06_exhaustion}
\input{sections/07_case_studies}
\input{sections/08_no_emergence}
\input{sections/09_main_theorem}
\input{sections/10_conclusion}

\appendix
\input{appendix/A_extended_cases}
\input{appendix/B_glossary}
\input{appendix/C_dependency_map}

\input{appendix/D_references}
